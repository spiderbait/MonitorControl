...
public class MonitorLoggerTest {
    // SpanLogger
    // CronLogger
    BatchInfoFetcher bif = new BatchInfoFetcher();
    Logger logger = LoggerFactory.getLogger(MonitorLoggerTest.class);
    ...
    public static void main(String[] args) {
        ...
        MonitorLoggerTest mlt = new MonitorLoggerTest();

        List<String> jobList = new ArrayList<String>();
        jobList.add("S04_ACCOUNT");
        jobList.add("S00_TREE");
        jobList.add("S99_BOS_PERSON");

        mlt.spanLogging("WHERE 1=1", "15:00:00 -> 16:00:00",
                "/Users/tianzhuoli/Desktop/BOS/20210225_MonitorControl/test_log/EDW_MONITOR_20210715.log", jobList, "END");
